    ...
    class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Notification>().HasData(
                new Notification { Id = 1, Type = "order_completed", IsRead = false, UserId = 3, Message = "Elinapoof" },
                new Notification { Id = 2, Type = "new_review", IsRead = false, UserId = 2, Message = "Skittles" },
                new Notification { Id = 3, Type = "new_order", IsRead = false, UserId = 5, Message = "Poof" },
                new Notification { Id = 4, Type = "new_review", IsRead = true, UserId = 4, Message = "Oreo" },
                new Notification { Id = 5, Type = "order_completed", IsRead = false, UserId = 6, Message = "Strawberry" },
                new Notification { Id = 6, Type = "new_order", IsRead = false, UserId = 4, Message = "Pipipi" }
            );
